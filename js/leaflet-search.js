...
L.Control.Search = L.Control.extend({
	...
	onAdd: function (map) {
		this._map = map;
		this._container = document.getElementById('leaflet-control-search')//L.DomUtil.create('div', 'leaflet-control-search');
	...
	_createAlert: function(className) {
		var alert = L.DomUtil.create('div', className, this._container); //document.getElementById('leaflet-control-search') //
	...
	_createInput: function (text, className) {
		...
		var input = document.getElementById('myInput') //L.DomUtil.create('input', className, this._container);
	...
	_createCancel: function (title, className) {
		...
		cancel.innerHTML = '<span><i class="fa fa-2x fa-times-circle" aria-hidden="true"></i></span>';//imageless(see css)
	...
	_createTip: function(text, val) {//val is object in recordCache, usually is Latlng
		...
		{
			tip = L.DomUtil.create('button', '');
			tip.innerHTML = text;
			tip.className = 'btn btn-default btn-lg'
			tip.style.width = '100%'
			/*
			tip = L.DomUtil.create('li', '');
			//tip.innerHTML = text;
			tip.innerHTML = '<b>'+text+'</b>';
			*/
		}
